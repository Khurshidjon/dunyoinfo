                            ...
                            <div class="tab-content">
                                <div class="tab-pane container-fluid active" id="home">
                                    ...
                                    <div class="form-group form-floating-label">
                                        <input id="title_uz" name="title_uz" type="text" class="form-control input-border-bottom" required value="{{ old('title_uz', $post->title_uz) }}">
                                        <label for="title_uz" class="placeholder">Sarlavha</label>
                                    </div>
                                    <div class="form-group form-floating-label">
                                        <textarea id="description_uz" name="description_uz" type="text" class="form-control input-border-bottom" required>{{ old('description_uz', $post->description_uz) }}</textarea>
                                        <label for="description_uz" class="placeholder">Tavsifi</label>
                                    </div>
                                    <div class="form-group">
                                        <textarea id="body_uz" name="body_uz" class="form-control input-border-bottom" required>{{ old('body_uz', $post->body_uz) }}</textarea>
                                ...
                                <div class="tab-pane container-fluid fade" id="menu1">
                                    ...
                                    <div class="form-group form-floating-label">
                                        <input id="title_cyrl" name="title_cyrl" type="text" class="form-control input-border-bottom" value="{{ old('title_cyrl', $post->title_cyrl) }}">
                                        <label for="title_cyrl" class="placeholder">Сарлавҳа</label>
                                    </div>
                                    <div class="form-group form-floating-label">
                                        <textarea id="description_cyrl" name="description_cyrl" type="text" class="form-control input-border-bottom">{{ old('description_cyrl', $post->description_cyrl) }}</textarea>
                                        <label for="description_cyrl" class="placeholder">Тавсифи</label>
                                    </div>
                                    <div class="form-group form-floating-label">
                                        <textarea id="body_cyrl" name="body_cyrl" type="text" class="form-control input-border-bottom">{{ old('body_cyrl', $post->body_cyrl) }}</textarea>
                                ...
                                <div class="tab-pane container-fluid fade" id="menu2">
                                    ...
                                    <div class="form-group form-floating-label">
                                        <input id="title_en" name="title_en" type="text" class="form-control input-border-bottom" value="{{ old('title_en', $post->title_en) }}">
                                        <label for="title_en" class="placeholder">Title</label>
                                    </div>
                                    <div class="form-group form-floating-label">
                                        <textarea id="description_en" name="description_en" type="text" class="form-control input-border-bottom">{{ old('description_en', $post->description_en) }}</textarea>
                                        <label for="description_en" class="placeholder">Description</label>
                                    </div>
                                    <div class="form-group form-floating-label">
                                        <textarea id="body_en" name="body_en" type="text" class="form-control input-border-bottom">{{ old('body_en', $post->body_en) }}</textarea>
                                ...
                                <div class="tab-pane container-fluid fade" id="menu3">
                                    ...
                                    <div class="form-group form-floating-label">
                                        <input id="title_ru" name="title_ru" type="text" class="form-control input-border-bottom" value="{{ old('title_ru', $post->title_ru) }}">
                                        <label for="title_ru" class="placeholder">Заглавие</label>
                                    </div>
                                    <div class="form-group form-floating-label">
                                        <textarea id="description_ru" name="description_ru" type="text" class="form-control input-border-bottom">{{ old('description_ru', $post->description_ru) }}</textarea>
                                        <label for="description_ru" class="placeholder">Описание</label>
                                    </div>
                                    <div class="form-group form-floating-label">
                                        <textarea id="body_ru" name="body_ru" type="text" class="form-control input-border-bottom">{{ old('body_ru', $post->body_ru) }}</textarea>
