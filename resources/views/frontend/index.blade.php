                    ...
                    <div class="row">
                        <div class="col-sm-8">
                            <div id="home-slider">
                                ...
                                <div class="post feature-post">
                                    <div class="entry-header">
                                        <div class="entry-thumbnail">
                                            <img class="img-responsive" src="{{ asset('frontend/images/post/slider/14.jpg') }}" alt="" />
                                        </div>
                                        <div class="catagory sports"><a href="#">Sports</a></div>
                                    </div>
                                    <div class="post-content">								
                                ...
                                <div class="post feature-post">
                                    <div class="entry-header">
                                        <div class="entry-thumbnail">
                                            <img class="img-responsive" src="{{ asset('frontend/images/post/slider/11.jpg') }}" alt="" />
                                        </div>
                                        <div class="catagory world"><a href="#">World</a></div>
                                    </div>
                                    <div class="post-content">								
                        ...
                        <div class="col-sm-4">
                            <div class="post feature-post">
                                <div class="entry-header">
                                    <div class="entry-thumbnail">
                                        <img class="img-responsive" src="{{ asset('frontend/images/post/slider/2.jpg') }}" alt="" />
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="post feature-post">
                                <div class="entry-header">
                                    <div class="entry-thumbnail">
                                        <img class="img-responsive" src="{{ asset('frontend/images/post/slider/3.jpg') }}" alt="" />
                                    </div>
                        ...
                        <div class="col-sm-4">
                            <div class="post feature-post">
                                <div class="entry-header">
                                    <div class="entry-thumbnail">
                                        <img class="img-responsive" src="{{ asset('frontend/images/post/slider/5.jpg') }}" alt="" />
                                    </div>
                                    <div class="catagory entertainment"><a href="#">Entertainment</a></div>
                                </div>
                                <div class="post-content">								
                        ...
                        <div class="col-sm-4">
                            <div class="post feature-post">
                                <div class="entry-header">
                                    <div class="entry-thumbnail">
                                        <img class="img-responsive" src="{{ asset('frontend/images/post/slider/6.jpg') }}" alt="" />
                                    </div>
                                    ...
                                    <div class="section photo-gallery">
                                        ...
                                        <div id="photo-gallery" class="carousel slide carousel-fade post" data-ride="carousel">						
                                            <div class="carousel-inner">
                                                ...
                                                <div class="item">
                                                    <a href="#"><img class="img-responsive" src="{{ asset('frontend/images/gallery/2.jpg') }}" alt="" /></a>
                                                    <h2><a href="#">500-pound elephant seal causes traffic jam while repeatedly</a></h2>
                                                </div>
                                                <div class="item">
                                                    <a href="#"><img class="img-responsive" src="{{ asset('frontend/images/gallery/3.jpg') }}" alt="" /></a>
                                                    <h2><a href="#">I rode a Metroboard electric skateboard 30 miles around Manhattan</a></h2>
                                                </div>
                                                <div class="item">
                                                    <a href="#"><img class="img-responsive" src="{{ asset('frontend/images/gallery/4.jpg') }}" alt="" /></a>
                                                    <h2><a href="#">The super creepy side of the Internet of Things and smart homes</a></h2>
                                                </div>
                                                <div class="item">
                                                    <a href="#"><img class="img-responsive" src="{{ asset('frontend/images/gallery/5.jpg') }}" alt="" /></a>
                                                    <h2><a href="#">Mirum est notare quam littera gothica, quam nunc putamus parum claram</a></h2>
                                                </div>
                                                <div class="item">
                                                    <a href="#"><img class="img-responsive" src="{{ asset('frontend/images/gallery/6.jpg') }}" alt="" /></a>
                                                    <h2><a href="#">Someone has calculated the total cost of saving Matt Damon</a></h2>
                                                </div>
                                                <div class="item">
                                                    <a href="#"><img class="img-responsive" src="{{ asset('frontend/images/gallery/7.jpg') }}" alt="" /></a>
                                                    <h2><a href="#">Wet wedding: Yorkshire couple dons wellies to tie the knot in flooded town</a></h2>
                                                </div>
                                                <div class="item">
                                                    <a href="#"><img class="img-responsive" src="{{ asset('frontend/images/gallery/8.jpg') }}" alt="" /></a>
                                                    <h2><a href="#">This dog is so stoked for his Christmas present he can hardly stand it</a></h2>
                                                </div>
                                                <div class="item">
                                                    <a href="#"><img class="img-responsive" src="{{ asset('frontend/images/gallery/9.jpg') }}" alt="" /></a>
                                            ...
                                            <ol class="gallery-indicators carousel-indicators">
                                                ...
                                                <li data-target="#photo-gallery" data-slide-to="1">
                                                    <img class="img-responsive" src="{{ asset('frontend/images/gallery/thumb2.png') }}" alt="" />
                                                </li>
                                                <li data-target="#photo-gallery" data-slide-to="2">
                                                    <img class="img-responsive" src="{{ asset('frontend/images/gallery/thumb3.png') }}" alt="" />
                                                </li>
                                                <li data-target="#photo-gallery" data-slide-to="3">
                                                    <img class="img-responsive" src="{{ asset('frontend/images/gallery/thumb4.png') }}" alt="" />
                                                </li>
                                                <li data-target="#photo-gallery" data-slide-to="4">
                                                    <img class="img-responsive" src="{{ asset('frontend/images/gallery/thumb5.png') }}" alt="" />
                                                </li>
                                                <li data-target="#photo-gallery" data-slide-to="5">
                                                    <img class="img-responsive" src="{{ asset('frontend/images/gallery/thumb6.png') }}" alt="" />
                                                </li>
                                                <li data-target="#photo-gallery" data-slide-to="6">
                                                    <img class="img-responsive" src="{{ asset('frontend/images/gallery/thumb7.png') }}" alt="" />
                                                </li>
                                                <li data-target="#photo-gallery" data-slide-to="7">
                                                    <img class="img-responsive" src="{{ asset('frontend/images/gallery/thumb8.png') }}" alt="" />
                                                </li>
                ...
                <div class="col-sm-8 col-sm-offset-2">
                    <div class="twitter-feeds">
                        <div class="twitter-feed">
                            <img class="img-responsive" src="{{ asset('frontend/images/others/twitter.png') }}" alt="" />
                            <h2>#Newspress</h2>
